...
- **تحویل اکانت میهمان:** به‌جای ارسال همه‌ی QR ها با هم، حالا برای هر کانفیگ یک دکمه نمایش داده می‌شود و QR فقط با زدن همان دکمه ساخته/ارسال می‌شود

### Fixed

- **نمایش اعداد در لیست پلن‌ها/قالب‌ها:** مشکل درهم‌ریختگی بصری اعداد هنگام ترکیب حجم/انقضا/قیمت در یک خط (مثلاً پلن ۳۰ روزه/۵۰ گیگ به‌صورت «3050.0» نمایش داده می‌شد) با قرار دادن هر فیلد در خط جداگانه برطرف شد؛ همچنین در پیام پرداخت میهمان، نوتیفیکیشن سفارش به ادمین، و تأیید حذف پلن/قالب

## [2.0.1] - 2026-07-26

### Added

- **پیش‌نمایش حالت میهمان (ادمین):** دکمه «👁 پیش‌نمایش حالت میهمان» در منوی ادمین، برای دیدن/تست فلوی خرید میهمان با همون اکانت ادمین/ریسلر (بدون نیاز به اکانت تلگرام جدا)؛ بازگشت به منوی ادمین با زدن `/start`

## [2.0.0] - 2026-07-26

### Added

- **جستجو در سرویس‌های ریسلر:** دکمه «🔍 جستجو» در لیست «سرویس‌های من» برای فیلتر کردن اکانت‌ها بر اساس بخشی از ایمیل/نام، با حفظ فیلتر هنگام صفحه‌بندی و بازگشت از جزئیات سرویس
- **کانال فروش مستقیم به میهمان:** کاربران عادی (غیر ریسلر) می‌توانند از منوی ربات پلن بخرند
  - ادمین پلن‌های قیمت‌دار (حجم + مدت + قیمت) تعریف می‌کند («🛍 پلن‌های میهمان»)
  - تنظیمات فروش میهمان: پنل/اینباند ثابت + شماره کارت («⚙️ تنظیمات فروش میهمان»)
  - میهمان پلن را انتخاب، کارت‌به‌کارت پرداخت و رسید (عکس/متن) ارسال می‌کند
  - ادمین سفارش را از داخل ربات تأیید/رد می‌کند؛ در تأیید، اکانت VLESS به‌صورت خودکار ساخته و لینک/QR برای میهمان ارسال می‌شود (از طریق یک ریسلر سیستمی مخفی که زیرساخت quota/XUI موجود را دوباره استفاده می‌کند)
  - «📦 سفارش‌های من» برای مشاهده وضعیت سفارش‌های میهمان
  - «🆘 پشتیبانی» برای ارسال مستقیم پیام/اسکرین‌شات مشکل به ادمین‌ها
  - محدودیت نرخ و جلوگیری از ثبت سفارش تکراری هم‌زمان برای میهمان
  - جلوگیری از حذف پلنی که سفارش در انتظار بررسی دارد

## [1.3.0] - 2026-07-06

### Removed

- حذف کامل دکمه و قابلیت «ریست ترافیک» کلاینت از منوی ریسلر جهت جلوگیری از دور زدن سهمیه (سقف حجم باقی‌مانده ریسلر). ریسلرها برای شارژ مجدد از دکمه‌های «افزودن ترافیک» و «تمدید انقضا» استفاده می‌کنند.
