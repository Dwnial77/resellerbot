...
ADMIN_GUEST_PREVIEW_NOTE = (
    "این پیش‌نمایش حالت میهمانه (همون منویی که کاربر معمولی می‌بینه).\n"
    "⚠️ هر کاری اینجا انجام بدی واقعی ثبت میشه (مثلاً سفارش خرید واقعی).\n"
    "برای برگشت به منوی ادمین، /start را بزنید."
)
